...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'bg-royal-900/90 backdrop-blur-md shadow-lg border-b border-white/10' : 'bg-transparent'}`}>
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex-shrink-0 flex items-center gap-2 cursor-pointer">
            ...
            <span className="text-2xl font-bold tracking-wider font-sans text-white">
              <span className="text-royal-gold mr-2">THE</span>ROYAL<span className="text-royal-gold ml-2">GYM</span>
            </span>
          </div>
          ...
          <div className="md:hidden">
            <button onClick={() => setIsOpen(!isOpen)} className="text-royal-gold hover:text-white transition-colors">
